...
namespace fruity.Migrations
{
    ...
    [Migration("20230405021649_AddApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fruity.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domains.TbBusniessInfo", b =>
                {
                    b.HasOne("Domains.TbCustomer", "Customer")
                        ...
                        .HasForeignKey("Domains.TbBusniessInfo", "CustomerId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("fruity.Models.ApplicationUser", null)
                        .WithMany()
